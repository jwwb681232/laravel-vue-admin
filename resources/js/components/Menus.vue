        ...
        data () {
            return {
                ...
                headers: [
                    ...
                    { text: 'Name',align:'center', value: 'name' ,width:'15%'},
                    { text: 'Icon', align:'center', value: 'icon' ,width:'15%'},
                    { text: 'Href', align:'center', value: 'href' ,width:'15%'},
                    { text: 'Parent ID', align:'center', value: 'parent_id' ,width:'15%'},
