        ...
        methods: {
            deleteItem(item){
                swal({
                    ...
                    if (result.value) {
                        this.createDialogForm.form.delete('api/role/'+item.id).then((res)=>{
            ...
            createDialogFormSubmit () {
                this.$validator.validateAll('create').then(result=>{
                    if(result){
                        this.createDialogForm.form.post('api/role').then((res)=>{
            ...
            editDialogFormSubmit () {
                this.$validator.validateAll('edit').then(result=>{
                    if(result){
                        this.editDialogForm.form.patch('api/role/'+this.editDialogForm.form.id).then((res)=>{
